...
var server = myHTTPserver
	//.use('/add/:a/:b/c/:d/e.html', function(rq,rs,n) {console.log('USE Func1');rs.send(parseInt(rq.reqHeaders.a)+parseInt(rq.reqHeaders.b)+parseInt(rq.reqHeaders.d));})
...
setTimeout(function() {
    ...
    {console.log('Req Func2');response.on('data', function(data){console.log(data.toString());});}).end();
}, 200);
